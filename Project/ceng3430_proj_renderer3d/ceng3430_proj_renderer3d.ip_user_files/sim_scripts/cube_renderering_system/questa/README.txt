...
#
# Generated by export_simulation on Thu May 18 12:42:40 +0800 2023
#
################################################################################
...
switch to the './cube_renderering_system.sh' script.

./cube_renderering_system.sh -reset_run
...
./cube_renderering_system.sh -noclean_files

For more information on the script, please type './cube_renderering_system.sh -help'.
