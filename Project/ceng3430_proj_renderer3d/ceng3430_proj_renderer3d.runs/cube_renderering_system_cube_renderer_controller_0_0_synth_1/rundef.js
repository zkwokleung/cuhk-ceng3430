...
ISEStep( "vivado",
         "-log cube_renderering_system_cube_renderer_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cube_renderering_system_cube_renderer_controller_0_0.tcl" );
