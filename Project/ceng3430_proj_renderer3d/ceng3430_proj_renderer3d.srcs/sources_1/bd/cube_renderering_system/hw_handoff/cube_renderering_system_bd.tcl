...
################################################################
# This is a generated script based on design: cube_renderering_system
#
...
# source cube_renderering_system_script.tcl
...
set design_name cube_renderering_system
...
proc create_root_design { parentCell } {
  ...
  set cube_renderer_controller_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:cube_renderer_controller:2.1 cube_renderer_controller_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins cube_renderer_controller_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net BTNC_1 [get_bd_ports BTNC] [get_bd_pins cube_renderer_controller_0/BTNC]
  connect_bd_net -net BTND_1 [get_bd_ports BTND] [get_bd_pins cube_renderer_controller_0/BTND]
  connect_bd_net -net BTNL_1 [get_bd_ports BTNL] [get_bd_pins cube_renderer_controller_0/BTNL]
  connect_bd_net -net BTNR_1 [get_bd_ports BTNR] [get_bd_pins cube_renderer_controller_0/BTNR]
  connect_bd_net -net BTNU_1 [get_bd_ports BTNU] [get_bd_pins cube_renderer_controller_0/BTNU]
  connect_bd_net -net CLK_1 [get_bd_ports CLK] [get_bd_pins cube_renderer_controller_0/CLK]
  connect_bd_net -net SW_1 [get_bd_ports SW] [get_bd_pins cube_renderer_controller_0/SW]
  connect_bd_net -net cube_renderer_controller_0_LED [get_bd_ports LED] [get_bd_pins cube_renderer_controller_0/LED]
  connect_bd_net -net cube_renderer_controller_0_VGA_BLUE [get_bd_ports VGA_BLUE] [get_bd_pins cube_renderer_controller_0/VGA_BLUE]
  connect_bd_net -net cube_renderer_controller_0_VGA_GREEN [get_bd_ports VGA_GREEN] [get_bd_pins cube_renderer_controller_0/VGA_GREEN]
  connect_bd_net -net cube_renderer_controller_0_VGA_HSYNC [get_bd_ports VGA_HSYNC] [get_bd_pins cube_renderer_controller_0/VGA_HSYNC]
  connect_bd_net -net cube_renderer_controller_0_VGA_RED [get_bd_ports VGA_RED] [get_bd_pins cube_renderer_controller_0/VGA_RED]
  connect_bd_net -net cube_renderer_controller_0_VGA_VSYNC [get_bd_ports VGA_VSYNC] [get_bd_pins cube_renderer_controller_0/VGA_VSYNC]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins cube_renderer_controller_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins cube_renderer_controller_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs cube_renderer_controller_0/S00_AXI/S00_AXI_reg] SEG_cube_renderer_controller_0_S00_AXI_reg
...
preplace port BTNU -pg 1 -y 120 -defaultsOSRD
preplace port VGA_VSYNC -pg 1 -y 180 -defaultsOSRD
preplace port BTNL -pg 1 -y 160 -defaultsOSRD
preplace port VGA_HSYNC -pg 1 -y 160 -defaultsOSRD
preplace port CLK -pg 1 -y 60 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 450 -defaultsOSRD
preplace port BTNC -pg 1 -y 100 -defaultsOSRD
preplace port BTND -pg 1 -y 140 -defaultsOSRD
preplace port BTNR -pg 1 -y 180 -defaultsOSRD
preplace portBus VGA_RED -pg 1 -y 140 -defaultsOSRD
preplace portBus VGA_BLUE -pg 1 -y 100 -defaultsOSRD
...
preplace inst cube_renderer_controller_0 -pg 1 -lvl 3 -y 130 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 310 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 510 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 3 NJ 430 NJ 430 NJ
preplace netloc CLK_1 1 0 3 NJ 60 NJ 60 NJ
preplace netloc cube_renderer_controller_0_VGA_RED 1 3 1 NJ
preplace netloc cube_renderer_controller_0_VGA_HSYNC 1 3 1 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 450
preplace netloc BTNR_1 1 0 3 NJ 180 NJ 180 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 220 410
preplace netloc BTND_1 1 0 3 NJ 140 NJ 140 NJ
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 1 1 420
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 450 NJ 450 NJ
preplace netloc BTNU_1 1 0 3 NJ 120 NJ 120 NJ
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 430 190 720
preplace netloc cube_renderer_controller_0_VGA_VSYNC 1 3 1 NJ
preplace netloc BTNL_1 1 0 3 NJ 160 NJ 160 NJ
preplace netloc cube_renderer_controller_0_VGA_GREEN 1 3 1 NJ
preplace netloc cube_renderer_controller_0_VGA_BLUE 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 200 440 570 730
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 710
preplace netloc BTNC_1 1 0 3 NJ 100 NJ 100 NJ
preplace netloc cube_renderer_controller_0_LED 1 3 1 NJ
preplace netloc SW_1 1 0 3 NJ 80 NJ 80 NJ
levelinfo -pg 1 0 220 580 870 1020 -top 0 -bot 640
",
}
